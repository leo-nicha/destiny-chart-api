...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // ✅ รองรับ topic=all
    const topics = topic === "all" ? ["personality", "career", "love", "finance"] : [topic];
